const sawav2 = {
    ...
    "bomb text": {     
        "name": "bomb text",
        "text": "O bomb text é uma função de auto envio e repetição de texto o qual pode ser programado o texto e a quantidade de repetições pelo próprio usuário. Para usá-lo basta entrar em uma conversa e apertar no ícone da bombinha no canto superior esquerdo!"
    },
     "check update": {   
        "name": "check update",
        "text": "A função checar atualização é uma função para informar o usuário sobre novas atualizações disponíveis. Basta o usuário ir em privacidade, opções de privacidade, checar atualização!",
    },
...
>>>>>>> 962888fbd6e722bce4f35fe8b3738c9f82f23bae
    ...
    "anti-deletar de mensagens": {   
        ...
        "text": "Essa é uma função muito importante, pois permite que o usuário possa visualizar a mensagem ainda que ela seja apagada pelo próprio remetente. Para ativá-la vá em privacidade, opções de privacidade, anti-deletar mensagens."
    },
    ...
    "fazer download de status": {   
        ...
        "text": "Essa função permite o usuário fazer download de qualquer status de qualquer pessoa. Para usá-la basta clicar em um status, clicar nos 3 pontinhos no canto superior direito, e clicar em Baixar este status 🤔."
    },
    ...
    "Clear cache avançado": {   
        "name": "Clear cache avançado",
        "text": "O clear cache avançado é um novo clear cache que limpa diretamente as pastas criadas pelo whatsapp, tais como whatsapp documents, whatsapp videos, whatsapp status entre outras."
    },
    "Fontes diferentes": {     
...
>>>>>>> 962888fbd6e722bce4f35fe8b3738c9f82f23bae
    ...
    "media settings": {   
        "name": "media settings",
        "text": "Função que permite configurações extras com relação ao envio de imagens e postagens de status"
    },
    "Bloqueio por pin": {     
    ...
    "Bloqueio Pattern": {   
        ...
        "text": "Novo tipo de bloqueio adicionado que permite proteger o whatsapp por desenho padrão."
    },
    "Encriptador de mensagens": {   
        "name": "Encriptador de mensagens",
        "text": "Pemite criptografar e descriptografar mensagens da categoria base64, sendo assim você pode conversar até coisas pessoais mesmo em grupos com uma pessoa específica que também usa o SA WhatsApp, que os demais participantes não saberão o seu recado."
    },
    "repetidor de texto": {   
        "name": "repetidor de texto",
        "text": "Função que permite repetir certo texto até mais de 1000 vezes."
    },
    "text emoji": {   
        "name": "text emoji",
        "text": "Permite transformar um texto escrito em letras em um escrito com emojis, basta escrever o texto, escolher o emoji e clicar em converter"
    },
    "Navegador web": {   
        "name": "Navegador web",
        "text": "é um navegador web implementado dentro do whatsapp, sendo assim você pode navegar da maneira que quiser sem nem mesmo sair do whatsapp"
    },
    "Vpn": {   
        "name": "Vpn",
        "text": "Vpn integrada no whatsapp que permite proteger sua navegação através de proxy http"
    },
    "sobre o desenvolvedor": {
    	   "name": "sobre o desenvolvedor",
    	   "text": "Esta opção mostra todos os dados referentes ao desenvolvedor do SA WhatsApp."
    },
    "Restart WhatsApp": {   
        "name": "Restart WhatsApp",
        "text": "Como o próprio nome já diz, essa função permite reiniciar o whatsapp como se você fechasse a janela do whatsapp e abrisse de novo."
    }  
};
...
window.onload = function(){
    ...
    document.getElementById("copyright").innerHTML = `© SA-MODS - ${new Date().getFullYear()}`;
    ...
    div_text.innerHTML = sawav2.select.text;
    
    
    function2_list.onchange = function() {
        let info2 = sawav2[this.value];
        div_text.innerHTML = info2.text;
    }
};
